...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Location-Bahrain%20🇧🇭-orange?style=for-the-badge" />

  <br/><br/>

  <img src="https://komarev.com/ghpvc/?username=mahwish07&label=Profile%20Views&color=blueviolet&style=flat-square" />
...
<p>
<strong>Name:</strong> Mehwish Akram<br>
<strong>Role:</strong> Data Analyst<br>
<strong>Location:</strong> Bahrain 🇧🇭<br>
...
<img src="https://user-images.githubusercontent.com/74038190/229223263-cf2e4b07-2615-4f87-9c38-e37600f8381a.gif" width="100%"><br><br>
...
```mermaid
graph LR
    A[📊 Raw Data] -->|Clean & Process| B[🧹 Quality Data]
    B -->|Explore & Analyze| C[🔍 Insights]
    C -->|Visualize| D[📈 Dashboards]
    D -->|Communicate| E[💼 Business Value]
    E -->|Iterate| A
    
    style A fill:#667eea,stroke:#333,stroke-width:2px
    style B fill:#764ba2,stroke:#333,stroke-width:2px
    style C fill:#f093fb,stroke:#333,stroke-width:2px
    style D fill:#4facfe,stroke:#333,stroke-width:2px
    style E fill:#00f2fe,stroke:#333,stroke-width:2px
```
...
<div align="center">
  <img src="https://quotes-github-readme.vercel.app/api?type=horizontal&theme=radical&animation=grow_out_in&quoteCategory=programming" alt="Random Dev Quote" />
</div>
